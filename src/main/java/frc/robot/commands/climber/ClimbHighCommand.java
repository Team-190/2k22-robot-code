...
public class ClimbHighCommand extends SequentialCommandGroup {

  ClimberSubsystem climberSubsystem;
  /** Creates a new ClimbMidBarCommand. */
  public ClimbHighCommand(RobotContainer robotContainer) {
    ...
    addCommands(
      ...
      new ClimberSetpointCommand(robotContainer, 0),
