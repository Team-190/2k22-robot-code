...
*
* <p>input: no sensors, patterns triggered by completion of actions
*
* <p>output: RGB patterns
*/
public class HotlineBlinkSubsystem extends SubsystemBase {
    private Spark blink;

    /** Constructs Abraham Blinkin */
    public HotlineBlinkSubsystem() {
        blink = new Spark(LEDConstants.HOTLINE_BLINK_CHANNEL);
    }
